...
from backend.app.tasks.celery_app import build_scheduler, celery_app
from backend.app.tasks.embedding_tasks import generate_embeddings
from backend.app.tasks.ingestion_tasks import collect_articles
